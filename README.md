...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,508 | 🐛 31 | 🌐 Go | 📅 2026-08-12 - Sarama is an MIT-licensed Go client library for Apache Kafka version 0.8 (and later).
...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,905 | 🐛 151 | 🌐 Java | 📅 2026-08-16 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
...
* [Burrow](https://github.com/linkedin/Burrow) ⭐ 3,959 | 🐛 251 | 🌐 Go | 📅 2026-07-16 - Kafka Consumer Lag Checking.
...
* [cruise-control](https://github.com/linkedin/cruise-control) ⭐ 3,039 | 🐛 289 | 🌐 Java | 📅 2026-08-15 - Cruise-control is the first of its kind to fully automate the dynamic workload rebalance and self-healing of a kafka cluster.
* [spring-kafka](https://github.com/spring-projects/spring-kafka) ⭐ 2,495 | 🐛 38 | 🌐 Java | 📅 2026-08-13
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,101 | 🐛 224 | 🌐 Java | 📅 2026-08-16 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
...
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 911 | 🐛 636 | 🌐 Java | 📅 2026-08-15 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,311 | 🐛 1,705 | 🌐 Java | 📅 2026-08-16
* [faust](https://github.com/robinhood/faust) ⭐ 6,823 | 🐛 278 | 🌐 Python | 📅 2024-07-27 - Python Stream Processing.
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,792 | 🐛 38 | 🌐 Java | 📅 2026-08-12
