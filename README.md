...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,521 | 🐛 33 | 🌐 Go | 📅 2026-09-21 - Sarama is an MIT-licensed Go client library for Apache Kafka version 0.8 (and later).
...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,937 | 🐛 156 | 🌐 Java | 📅 2026-09-21 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
...
* [Burrow](https://github.com/linkedin/Burrow) ⭐ 3,962 | 🐛 250 | 🌐 Go | 📅 2026-08-21 - Kafka Consumer Lag Checking.
* [kafkahq](https://github.com/tchiotludo/kafkahq) ⭐ 3,855 | 🐛 284 | 🌐 Java | 📅 2026-09-21 - Kafka GUI for topics, topics data, consumers group, schema registry, connect and more.
* [kafka-eagle](https://github.com/smartloli/kafka-eagle) ⭐ 3,182 | 🐛 224 | 🌐 Java | 📅 2026-09-12 - Used to monitor the consumer status of Kafka clusters, as well as offsets, metadata and other information.
* [cruise-control](https://github.com/linkedin/cruise-control) ⭐ 3,045 | 🐛 275 | 🌐 Java | 📅 2026-09-18 - Cruise-control is the first of its kind to fully automate the dynamic workload rebalance and self-healing of a kafka cluster.
* [spring-kafka](https://github.com/spring-projects/spring-kafka) ⭐ 2,506 | 🐛 35 | 🌐 Java | 📅 2026-09-18
...
* [reactive-kafka](https://github.com/akka/reactive-kafka) ⭐ 1,421 | 🐛 114 | 🌐 Scala | 📅 2026-09-16 - Alpakka Kafka connector - Alpakka is a Reactive Enterprise Integration library for Java and Scala, based on Reactive Streams and Akka.
* [kt](https://github.com/fgeller/kt) ⭐ 955 | 🐛 11 | 🌐 Go | 📅 2024-04-08 - Kafka command line tool.
* [uReplicator](https://github.com/uber/uReplicator) ⭐ 936 | 🐛 79 | 🌐 Java | 📅 2023-12-16 - Improvement of Apache Kafka Mirrormaker.
* [hermes](https://github.com/allegro/hermes) ⭐ 870 | 🐛 7 | 🌐 Java | 📅 2026-08-18 - Fast and reliable message broker built on top of Kafka.
* [kafka-pixy](https://github.com/mailgun/kafka-pixy) ⭐ 790 | 🐛 17 | 🌐 Go | 📅 2024-04-23 - Kafka-Pixy is a dual API (gRPC and REST) proxy for Kafka with automatic consumer group control.
...
* [kafka-tools](https://github.com/linkedin/kafka-tools) ⭐ 599 | 🐛 24 | 🌐 Python | 📅 2022-01-24 - A collection of tools for working with Apache Kafka.
...
* [mirus](https://github.com/salesforce/mirus) ⭐ 211 | 🐛 30 | 🌐 Java | 📅 2026-09-15 - Mirus is a cross data-center data replication tool for Apache Kafka.
...
* [Kafdrop](https://github.com/obsidiandynamics/kafdrop) ⭐ 6,156 | 🐛 42 | 🌐 Java | 📅 2026-09-21 - Web UI for browsing Kafka topics and consumer groups.
* [kowl](https://github.com/cloudhut/kowl) ⭐ 4,334 | 🐛 148 | 🌐 TypeScript | 📅 2026-09-21
...
* [cruise-control-ui](https://github.com/linkedin/cruise-control-ui) ⭐ 374 | 🐛 25 | 🌐 Vue | 📅 2024-08-20
...
* [Maxwell](https://github.com/zendesk/maxwell) ⭐ 4,260 | 🐛 267 | 🌐 Java | 📅 2026-09-19
...
* [snowflake-kafka-connector](https://github.com/snowflakedb/snowflake-kafka-connector) ⭐ 177 | 🐛 54 | 🌐 Java | 📅 2026-09-19
* [kafka-connect-transform-common](https://github.com/jcustenborder/kafka-connect-transform-common) ⭐ 175 | 🐛 27 | 🌐 Java | 📅 2026-07-08 - Common Transforms for Kafka Connect.
...
* [aiven-kafka-connect-transforms](https://github.com/aiven/aiven-kafka-connect-transforms) ⭐ 90 | 🐛 14 | 🌐 Java | 📅 2026-08-01 - A collection of Single Message Transformations (SMTs) for Kafka Connect.
* [kafka-connect-client](https://github.com/SourceLabOrg/kafka-connect-client) ⭐ 43 | 🐛 10 | 🌐 Java | 📅 2025-06-26 - A kafka-connect REST api client for java.
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,721 | 🐛 277 | 🌐 Java | 📅 2026-09-21 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [strimzi-http-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ⭐ 341 | 🐛 14 | 🌐 Java | 📅 2026-09-21 - Strimzi Kafka Bridge (AMQP & HTTP).
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 164 | 🐛 277 | 🌐 Java | 📅 2026-09-21 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,465 | 🐛 391 | 🌐 Java | 📅 2026-09-21 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 936 | 🐛 735 | 🌐 Java | 📅 2026-09-21 - Apicurio API/schema registry (includes UI).
...
* [infoslack/awesome-kafka](https://github.com/infoslack/awesome-kafka) ⭐ 593 | 🐛 2 | 📅 2026-05-05
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,334 | 🐛 1,745 | 🌐 Java | 📅 2026-09-21
* [faust](https://github.com/robinhood/faust) ⭐ 6,824 | 🐛 280 | 🌐 Python | 📅 2024-07-27 - Python Stream Processing.
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,815 | 🐛 50 | 🌐 Java | 📅 2026-09-20
* [Heron](https://github.com/apache/incubator-heron) ⚠️ Archived
* [CorfuDB](https://github.com/CorfuDB/CorfuDB) ⭐ 668 | 🐛 202 | 🌐 Java | 📅 2026-09-21
