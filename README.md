...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,922 | 🐛 156 | 🌐 Java | 📅 2026-08-27 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
...
* [spring-kafka](https://github.com/spring-projects/spring-kafka) ⭐ 2,499 | 🐛 46 | 🌐 Java | 📅 2026-08-29
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,717 | 🐛 227 | 🌐 Java | 📅 2026-08-29 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
...
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 922 | 🐛 620 | 🌐 Java | 📅 2026-08-29 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,317 | 🐛 1,731 | 🌐 Java | 📅 2026-08-28
