...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,513 | 🐛 39 | 🌐 Go | 📅 2026-09-04 - Sarama is an MIT-licensed Go client library for Apache Kafka version 0.8 (and later).
...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,926 | 🐛 160 | 🌐 Java | 📅 2026-09-03 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
...
* [kafkahq](https://github.com/tchiotludo/kafkahq) ⭐ 3,852 | 🐛 290 | 🌐 Java | 📅 2026-09-02 - Kafka GUI for topics, topics data, consumers group, schema registry, connect and more.
...
* [spring-kafka](https://github.com/spring-projects/spring-kafka) ⭐ 2,501 | 🐛 45 | 🌐 Java | 📅 2026-09-04
...
* [kowl](https://github.com/cloudhut/kowl) ⭐ 4,329 | 🐛 154 | 🌐 TypeScript | 📅 2026-09-04
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,732 | 🐛 248 | 🌐 Java | 📅 2026-09-04 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [strimzi-http-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ⭐ 339 | 🐛 15 | 🌐 Java | 📅 2026-09-02 - Strimzi Kafka Bridge (AMQP & HTTP).
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 162 | 🐛 277 | 🌐 Java | 📅 2026-09-04 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,463 | 🐛 393 | 🌐 Java | 📅 2026-09-04 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 930 | 🐛 640 | 🌐 Java | 📅 2026-09-04 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,325 | 🐛 1,736 | 🌐 Java | 📅 2026-09-03
* [faust](https://github.com/robinhood/faust) ⭐ 6,825 | 🐛 280 | 🌐 Python | 📅 2024-07-27 - Python Stream Processing.
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,804 | 🐛 49 | 🌐 Java | 📅 2026-09-04
