...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,511 | 🐛 33 | 🌐 Go | 📅 2026-08-25 - Sarama is an MIT-licensed Go client library for Apache Kafka version 0.8 (and later).
...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,916 | 🐛 151 | 🌐 Java | 📅 2026-08-26 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
...
* [kafkahq](https://github.com/tchiotludo/kafkahq) ⭐ 3,849 | 🐛 284 | 🌐 Java | 📅 2026-08-24 - Kafka GUI for topics, topics data, consumers group, schema registry, connect and more.
...
* [reactive-kafka](https://github.com/akka/reactive-kafka) ⭐ 1,422 | 🐛 112 | 🌐 Scala | 📅 2026-08-26 - Alpakka Kafka connector - Alpakka is a Reactive Enterprise Integration library for Java and Scala, based on Reactive Streams and Akka.
...
* [Kafdrop](https://github.com/obsidiandynamics/kafdrop) ⭐ 6,153 | 🐛 46 | 🌐 Java | 📅 2026-08-25 - Web UI for browsing Kafka topics and consumer groups.
* [kowl](https://github.com/cloudhut/kowl) ⭐ 4,324 | 🐛 153 | 🌐 TypeScript | 📅 2026-08-26
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,717 | 🐛 228 | 🌐 Java | 📅 2026-08-26 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [strimzi-http-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ⭐ 338 | 🐛 14 | 🌐 Java | 📅 2026-08-25 - Strimzi Kafka Bridge (AMQP & HTTP).
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 162 | 🐛 276 | 🌐 Java | 📅 2026-08-26 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,462 | 🐛 395 | 🌐 Java | 📅 2026-08-26 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 921 | 🐛 630 | 🌐 Java | 📅 2026-08-26 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,314 | 🐛 1,748 | 🌐 Java | 📅 2026-08-26
* [faust](https://github.com/robinhood/faust) ⭐ 6,825 | 🐛 279 | 🌐 Python | 📅 2024-07-27 - Python Stream Processing.
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,797 | 🐛 45 | 🌐 Java | 📅 2026-08-26
* [Heron](https://github.com/apache/incubator-heron) ⚠️ Archived
* [CorfuDB](https://github.com/CorfuDB/CorfuDB) ⭐ 665 | 🐛 200 | 🌐 Java | 📅 2026-08-25
