...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,508 | 🐛 33 | 🌐 Go | 📅 2026-08-18 - Sarama is an MIT-licensed Go client library for Apache Kafka version 0.8 (and later).
...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,907 | 🐛 159 | 🌐 Java | 📅 2026-08-17 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
...
* [kafkahq](https://github.com/tchiotludo/kafkahq) ⭐ 3,846 | 🐛 274 | 🌐 Java | 📅 2026-08-17 - Kafka GUI for topics, topics data, consumers group, schema registry, connect and more.
...
* [cruise-control](https://github.com/linkedin/cruise-control) ⭐ 3,039 | 🐛 287 | 🌐 Java | 📅 2026-08-17 - Cruise-control is the first of its kind to fully automate the dynamic workload rebalance and self-healing of a kafka cluster.
* [spring-kafka](https://github.com/spring-projects/spring-kafka) ⭐ 2,495 | 🐛 40 | 🌐 Java | 📅 2026-08-13
...
* [hermes](https://github.com/allegro/hermes) ⭐ 865 | 🐛 8 | 🌐 Java | 📅 2026-08-18 - Fast and reliable message broker built on top of Kafka.
...
* [kowl](https://github.com/cloudhut/kowl) ⭐ 4,319 | 🐛 153 | 🌐 TypeScript | 📅 2026-08-18
...
* [Maxwell](https://github.com/zendesk/maxwell) ⭐ 4,254 | 🐛 265 | 🌐 Java | 📅 2026-08-13
...
* [snowflake-kafka-connector](https://github.com/snowflakedb/snowflake-kafka-connector) ⭐ 175 | 🐛 50 | 🌐 Java | 📅 2026-08-18
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,425 | 🐛 226 | 🌐 Java | 📅 2026-08-18 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [strimzi-http-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ⭐ 338 | 🐛 16 | 🌐 Java | 📅 2026-08-14 - Strimzi Kafka Bridge (AMQP & HTTP).
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 162 | 🐛 275 | 🌐 Java | 📅 2026-08-18 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,461 | 🐛 396 | 🌐 Java | 📅 2026-08-18 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 915 | 🐛 645 | 🌐 Java | 📅 2026-08-18 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,312 | 🐛 1,724 | 🌐 Java | 📅 2026-08-18
* [faust](https://github.com/robinhood/faust) ⭐ 6,823 | 🐛 279 | 🌐 Python | 📅 2024-07-27 - Python Stream Processing.
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,794 | 🐛 39 | 🌐 Java | 📅 2026-08-18
