...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,520 | 🐛 45 | 🌐 Go | 📅 2026-09-09 - Sarama is an MIT-licensed Go client library for Apache Kafka version 0.8 (and later).
...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,933 | 🐛 156 | 🌐 Java | 📅 2026-09-13 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
...
* [kafkahq](https://github.com/tchiotludo/kafkahq) ⭐ 3,854 | 🐛 262 | 🌐 Java | 📅 2026-09-11 - Kafka GUI for topics, topics data, consumers group, schema registry, connect and more.
...
* [spring-kafka](https://github.com/spring-projects/spring-kafka) ⭐ 2,504 | 🐛 46 | 🌐 Java | 📅 2026-09-12
...
* [kowl](https://github.com/cloudhut/kowl) ⭐ 4,332 | 🐛 152 | 🌐 TypeScript | 📅 2026-09-11
...
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 162 | 🐛 277 | 🌐 Java | 📅 2026-09-13 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,465 | 🐛 392 | 🌐 Java | 📅 2026-09-13 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 934 | 🐛 691 | 🌐 Java | 📅 2026-09-12 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,329 | 🐛 1,733 | 🌐 Java | 📅 2026-09-13
* [faust](https://github.com/robinhood/faust) ⭐ 6,825 | 🐛 280 | 🌐 Python | 📅 2024-07-27 - Python Stream Processing.
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,811 | 🐛 47 | 🌐 Java | 📅 2026-09-13
