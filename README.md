...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,512 | 🐛 40 | 🌐 Go | 📅 2026-09-04 - Sarama is an MIT-licensed Go client library for Apache Kafka version 0.8 (and later).
...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,927 | 🐛 159 | 🌐 Java | 📅 2026-09-05 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
* [kafkacat](https://github.com/edenhill/kafkacat) ⭐ 5,779 | 🐛 162 | 🌐 C | 📅 2024-07-09 - Generic command line non-JVM Apache Kafka producer and consumer.
* [jocko](https://github.com/travisjeffery/jocko) ⭐ 5,011 | 🐛 64 | 🌐 Go | 📅 2026-05-20 - Kafka implemented in Golang with built-in coordination (No ZK dep, single binary install, Cloud Native).
* [Burrow](https://github.com/linkedin/Burrow) ⭐ 3,960 | 🐛 250 | 🌐 Go | 📅 2026-08-21 - Kafka Consumer Lag Checking.
* [kafkahq](https://github.com/tchiotludo/kafkahq) ⭐ 3,852 | 🐛 291 | 🌐 Java | 📅 2026-09-02 - Kafka GUI for topics, topics data, consumers group, schema registry, connect and more.
...
* [spring-kafka](https://github.com/spring-projects/spring-kafka) ⭐ 2,502 | 🐛 50 | 🌐 Java | 📅 2026-09-05
...
* [Kafdrop](https://github.com/obsidiandynamics/kafdrop) ⭐ 6,152 | 🐛 43 | 🌐 Java | 📅 2026-09-03 - Web UI for browsing Kafka topics and consumer groups.
* [kowl](https://github.com/cloudhut/kowl) ⭐ 4,330 | 🐛 162 | 🌐 TypeScript | 📅 2026-09-05
...
* [snowflake-kafka-connector](https://github.com/snowflakedb/snowflake-kafka-connector) ⭐ 177 | 🐛 51 | 🌐 Java | 📅 2026-09-06
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,730 | 🐛 242 | 🌐 Java | 📅 2026-09-06 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [strimzi-http-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ⭐ 339 | 🐛 15 | 🌐 Java | 📅 2026-09-02 - Strimzi Kafka Bridge (AMQP & HTTP).
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 162 | 🐛 277 | 🌐 Java | 📅 2026-09-05 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,464 | 🐛 394 | 🌐 Java | 📅 2026-09-05 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 931 | 🐛 637 | 🌐 Java | 📅 2026-09-06 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,326 | 🐛 1,742 | 🌐 Java | 📅 2026-09-05
* [faust](https://github.com/robinhood/faust) ⭐ 6,825 | 🐛 280 | 🌐 Python | 📅 2024-07-27 - Python Stream Processing.
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,806 | 🐛 51 | 🌐 Java | 📅 2026-09-05
