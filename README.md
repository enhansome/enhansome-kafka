...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,515 | 🐛 43 | 🌐 Go | 📅 2026-09-07 - Sarama is an MIT-licensed Go client library for Apache Kafka version 0.8 (and later).
...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,928 | 🐛 163 | 🌐 Java | 📅 2026-09-07 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
...
* [kafkahq](https://github.com/tchiotludo/kafkahq) ⭐ 3,852 | 🐛 298 | 🌐 Java | 📅 2026-09-07 - Kafka GUI for topics, topics data, consumers group, schema registry, connect and more.
...
* [spring-kafka](https://github.com/spring-projects/spring-kafka) ⭐ 2,503 | 🐛 41 | 🌐 Java | 📅 2026-09-07
...
* [Kafdrop](https://github.com/obsidiandynamics/kafdrop) ⭐ 6,151 | 🐛 44 | 🌐 Java | 📅 2026-09-07 - Web UI for browsing Kafka topics and consumer groups.
* [kowl](https://github.com/cloudhut/kowl) ⭐ 4,331 | 🐛 161 | 🌐 TypeScript | 📅 2026-09-07
...
* [snowflake-kafka-connector](https://github.com/snowflakedb/snowflake-kafka-connector) ⭐ 177 | 🐛 50 | 🌐 Java | 📅 2026-09-07
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,730 | 🐛 242 | 🌐 Java | 📅 2026-09-07 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [strimzi-http-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ⭐ 339 | 🐛 15 | 🌐 Java | 📅 2026-09-02 - Strimzi Kafka Bridge (AMQP & HTTP).
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 162 | 🐛 277 | 🌐 Java | 📅 2026-09-07 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,464 | 🐛 394 | 🌐 Java | 📅 2026-09-07 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 931 | 🐛 648 | 🌐 Java | 📅 2026-09-07 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,326 | 🐛 1,752 | 🌐 Java | 📅 2026-09-07
* [faust](https://github.com/robinhood/faust) ⭐ 6,825 | 🐛 280 | 🌐 Python | 📅 2024-07-27 - Python Stream Processing.
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,806 | 🐛 52 | 🌐 Java | 📅 2026-09-07
