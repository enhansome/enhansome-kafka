...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,523 | 🐛 43 | 🌐 Go | 📅 2026-09-17 - Sarama is an MIT-licensed Go client library for Apache Kafka version 0.8 (and later).
...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,934 | 🐛 156 | 🌐 Java | 📅 2026-09-17 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
...
* [spring-kafka](https://github.com/spring-projects/spring-kafka) ⭐ 2,507 | 🐛 40 | 🌐 Java | 📅 2026-09-16
...
* [reactive-kafka](https://github.com/akka/reactive-kafka) ⭐ 1,422 | 🐛 114 | 🌐 Scala | 📅 2026-09-16 - Alpakka Kafka connector - Alpakka is a Reactive Enterprise Integration library for Java and Scala, based on Reactive Streams and Akka.
...
* [Kafdrop](https://github.com/obsidiandynamics/kafdrop) ⭐ 6,156 | 🐛 43 | 🌐 Java | 📅 2026-09-15 - Web UI for browsing Kafka topics and consumer groups.
...
* [snowflake-kafka-connector](https://github.com/snowflakedb/snowflake-kafka-connector) ⭐ 177 | 🐛 50 | 🌐 Java | 📅 2026-09-16
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,724 | 🐛 256 | 🌐 Java | 📅 2026-09-17 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [strimzi-http-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ⭐ 341 | 🐛 16 | 🌐 Java | 📅 2026-09-17 - Strimzi Kafka Bridge (AMQP & HTTP).
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 163 | 🐛 278 | 🌐 Java | 📅 2026-09-17 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,466 | 🐛 395 | 🌐 Java | 📅 2026-09-17 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 936 | 🐛 707 | 🌐 Java | 📅 2026-09-17 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,332 | 🐛 1,741 | 🌐 Java | 📅 2026-09-17
* [faust](https://github.com/robinhood/faust) ⭐ 6,824 | 🐛 280 | 🌐 Python | 📅 2024-07-27 - Python Stream Processing.
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,813 | 🐛 47 | 🌐 Java | 📅 2026-09-17
