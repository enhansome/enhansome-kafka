...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,521 | 🐛 29 | 🌐 Go | 📅 2026-09-22 - Sarama is an MIT-licensed Go client library for Apache Kafka version 0.8 (and later).
...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,938 | 🐛 160 | 🌐 Java | 📅 2026-09-22 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
...
* [kafkahq](https://github.com/tchiotludo/kafkahq) ⭐ 3,855 | 🐛 288 | 🌐 Java | 📅 2026-09-21 - Kafka GUI for topics, topics data, consumers group, schema registry, connect and more.
...
* [cruise-control](https://github.com/linkedin/cruise-control) ⭐ 3,045 | 🐛 274 | 🌐 Java | 📅 2026-09-22 - Cruise-control is the first of its kind to fully automate the dynamic workload rebalance and self-healing of a kafka cluster.
* [spring-kafka](https://github.com/spring-projects/spring-kafka) ⭐ 2,507 | 🐛 36 | 🌐 Java | 📅 2026-09-18
...
* [kowl](https://github.com/cloudhut/kowl) ⭐ 4,334 | 🐛 150 | 🌐 TypeScript | 📅 2026-09-22
...
* [snowflake-kafka-connector](https://github.com/snowflakedb/snowflake-kafka-connector) ⭐ 177 | 🐛 54 | 🌐 Java | 📅 2026-09-21
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,720 | 🐛 277 | 🌐 Java | 📅 2026-09-21 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [strimzi-http-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ⭐ 341 | 🐛 14 | 🌐 Java | 📅 2026-09-21 - Strimzi Kafka Bridge (AMQP & HTTP).
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 165 | 🐛 277 | 🌐 Java | 📅 2026-09-22 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,465 | 🐛 392 | 🌐 Java | 📅 2026-09-22 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 936 | 🐛 744 | 🌐 Java | 📅 2026-09-22 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,336 | 🐛 1,754 | 🌐 Java | 📅 2026-09-22
