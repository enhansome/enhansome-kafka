...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,518 | 🐛 48 | 🌐 Go | 📅 2026-09-25 - Sarama is an MIT-licensed Go client library for Apache Kafka version 0.8 (and later).
...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,942 | 🐛 156 | 🌐 Java | 📅 2026-09-25 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
...
* [Burrow](https://github.com/linkedin/Burrow) ⭐ 3,964 | 🐛 252 | 🌐 Go | 📅 2026-08-21 - Kafka Consumer Lag Checking.
* [kafkahq](https://github.com/tchiotludo/kafkahq) ⭐ 3,858 | 🐛 283 | 🌐 Java | 📅 2026-09-25 - Kafka GUI for topics, topics data, consumers group, schema registry, connect and more.
...
* [cruise-control](https://github.com/linkedin/cruise-control) ⭐ 3,045 | 🐛 276 | 🌐 Java | 📅 2026-09-25 - Cruise-control is the first of its kind to fully automate the dynamic workload rebalance and self-healing of a kafka cluster.
...
* [kowl](https://github.com/cloudhut/kowl) ⭐ 4,334 | 🐛 147 | 🌐 TypeScript | 📅 2026-09-25
...
* [snowflake-kafka-connector](https://github.com/snowflakedb/snowflake-kafka-connector) ⭐ 177 | 🐛 52 | 🌐 Java | 📅 2026-09-25
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,715 | 🐛 283 | 🌐 Java | 📅 2026-09-25 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [strimzi-http-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ⭐ 342 | 🐛 14 | 🌐 Java | 📅 2026-09-24 - Strimzi Kafka Bridge (AMQP & HTTP).
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 165 | 🐛 277 | 🌐 Java | 📅 2026-09-25 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,464 | 🐛 393 | 🌐 Java | 📅 2026-09-25 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 939 | 🐛 741 | 🌐 Java | 📅 2026-09-25 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,338 | 🐛 1,759 | 🌐 Java | 📅 2026-09-25
* [faust](https://github.com/robinhood/faust) ⭐ 6,823 | 🐛 280 | 🌐 Python | 📅 2024-07-27 - Python Stream Processing.
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,818 | 🐛 50 | 🌐 Java | 📅 2026-09-25
* [Heron](https://github.com/apache/incubator-heron) ⚠️ Archived
* [CorfuDB](https://github.com/CorfuDB/CorfuDB) ⭐ 668 | 🐛 203 | 🌐 Java | 📅 2026-09-24
