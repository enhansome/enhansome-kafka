...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,512 | 🐛 31 | 🌐 Go | 📅 2026-08-23 - Sarama is an MIT-licensed Go client library for Apache Kafka version 0.8 (and later).
...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,915 | 🐛 152 | 🌐 Java | 📅 2026-08-25 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
...
* [Kafdrop](https://github.com/obsidiandynamics/kafdrop) ⭐ 6,154 | 🐛 45 | 🌐 Java | 📅 2026-08-24 - Web UI for browsing Kafka topics and consumer groups.
* [kowl](https://github.com/cloudhut/kowl) ⭐ 4,325 | 🐛 154 | 🌐 TypeScript | 📅 2026-08-25
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,716 | 🐛 222 | 🌐 Java | 📅 2026-08-25 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [strimzi-http-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ⭐ 338 | 🐛 15 | 🌐 Java | 📅 2026-08-25 - Strimzi Kafka Bridge (AMQP & HTTP).
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 162 | 🐛 276 | 🌐 Java | 📅 2026-08-25 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,462 | 🐛 395 | 🌐 Java | 📅 2026-08-25 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 920 | 🐛 635 | 🌐 Java | 📅 2026-08-25 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,311 | 🐛 1,749 | 🌐 Java | 📅 2026-08-24
* [faust](https://github.com/robinhood/faust) ⭐ 6,824 | 🐛 279 | 🌐 Python | 📅 2024-07-27 - Python Stream Processing.
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,796 | 🐛 46 | 🌐 Java | 📅 2026-08-25
* [Heron](https://github.com/apache/incubator-heron) ⚠️ Archived
* [CorfuDB](https://github.com/CorfuDB/CorfuDB) ⭐ 665 | 🐛 200 | 🌐 Java | 📅 2026-08-24
