...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,508 | 🐛 32 | 🌐 Go | 📅 2026-08-17 - Sarama is an MIT-licensed Go client library for Apache Kafka version 0.8 (and later).
...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,905 | 🐛 154 | 🌐 Java | 📅 2026-08-17 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
* [kafkacat](https://github.com/edenhill/kafkacat) ⭐ 5,777 | 🐛 162 | 🌐 C | 📅 2024-07-09 - Generic command line non-JVM Apache Kafka producer and consumer.
...
* [kafkahq](https://github.com/tchiotludo/kafkahq) ⭐ 3,844 | 🐛 273 | 🌐 Java | 📅 2026-08-17 - Kafka GUI for topics, topics data, consumers group, schema registry, connect and more.
...
* [reactive-kafka](https://github.com/akka/reactive-kafka) ⭐ 1,422 | 🐛 114 | 🌐 Scala | 📅 2026-08-17 - Alpakka Kafka connector - Alpakka is a Reactive Enterprise Integration library for Java and Scala, based on Reactive Streams and Akka.
...
* [hermes](https://github.com/allegro/hermes) ⭐ 865 | 🐛 8 | 🌐 Java | 📅 2026-08-17 - Fast and reliable message broker built on top of Kafka.
...
* [kowl](https://github.com/cloudhut/kowl) ⭐ 4,318 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-14
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,239 | 🐛 225 | 🌐 Java | 📅 2026-08-17 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [strimzi-http-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ⭐ 338 | 🐛 16 | 🌐 Java | 📅 2026-08-14 - Strimzi Kafka Bridge (AMQP & HTTP).
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 162 | 🐛 275 | 🌐 Java | 📅 2026-08-17 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,461 | 🐛 393 | 🌐 Java | 📅 2026-08-17 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 913 | 🐛 630 | 🌐 Java | 📅 2026-08-17 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,313 | 🐛 1,711 | 🌐 Java | 📅 2026-08-17
