...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,519 | 🐛 29 | 🌐 Go | 📅 2026-09-22 - Sarama is an MIT-licensed Go client library for Apache Kafka version 0.8 (and later).
...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,940 | 🐛 160 | 🌐 Java | 📅 2026-09-23 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
...
* [Burrow](https://github.com/linkedin/Burrow) ⭐ 3,964 | 🐛 250 | 🌐 Go | 📅 2026-08-21 - Kafka Consumer Lag Checking.
* [kafkahq](https://github.com/tchiotludo/kafkahq) ⭐ 3,857 | 🐛 286 | 🌐 Java | 📅 2026-09-23 - Kafka GUI for topics, topics data, consumers group, schema registry, connect and more.
...
* [cruise-control](https://github.com/linkedin/cruise-control) ⭐ 3,045 | 🐛 274 | 🌐 Java | 📅 2026-09-23 - Cruise-control is the first of its kind to fully automate the dynamic workload rebalance and self-healing of a kafka cluster.
* [spring-kafka](https://github.com/spring-projects/spring-kafka) ⭐ 2,508 | 🐛 36 | 🌐 Java | 📅 2026-09-18
* [kafka-monitor](https://github.com/linkedin/kafka-monitor) ⭐ 2,065 | 🐛 33 | 🌐 Java | 📅 2025-03-09
* [secor](https://github.com/pinterest/secor) ⭐ 1,858 | 🐛 270 | 🌐 Java | 📅 2026-03-10 - Secor is a service implementing Kafka log persistence.
...
* [Kafdrop](https://github.com/obsidiandynamics/kafdrop) ⭐ 6,156 | 🐛 43 | 🌐 Java | 📅 2026-09-21 - Web UI for browsing Kafka topics and consumer groups.
* [kowl](https://github.com/cloudhut/kowl) ⭐ 4,334 | 🐛 148 | 🌐 TypeScript | 📅 2026-09-23
...
* [Maxwell](https://github.com/zendesk/maxwell) ⭐ 4,260 | 🐛 265 | 🌐 Java | 📅 2026-09-23
...
* [snowflake-kafka-connector](https://github.com/snowflakedb/snowflake-kafka-connector) ⭐ 177 | 🐛 53 | 🌐 Java | 📅 2026-09-22
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,719 | 🐛 277 | 🌐 Java | 📅 2026-09-23 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [strimzi-http-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ⭐ 342 | 🐛 14 | 🌐 Java | 📅 2026-09-21 - Strimzi Kafka Bridge (AMQP & HTTP).
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 165 | 🐛 277 | 🌐 Java | 📅 2026-09-23 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,465 | 🐛 392 | 🌐 Java | 📅 2026-09-23 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 938 | 🐛 743 | 🌐 Java | 📅 2026-09-23 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,337 | 🐛 1,748 | 🌐 Java | 📅 2026-09-23
* [faust](https://github.com/robinhood/faust) ⭐ 6,824 | 🐛 280 | 🌐 Python | 📅 2024-07-27 - Python Stream Processing.
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,815 | 🐛 50 | 🌐 Java | 📅 2026-09-23
* [Heron](https://github.com/apache/incubator-heron) ⚠️ Archived
* [CorfuDB](https://github.com/CorfuDB/CorfuDB) ⭐ 668 | 🐛 203 | 🌐 Java | 📅 2026-09-22
