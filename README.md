...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,519 | 🐛 49 | 🌐 Go | 📅 2026-09-25 - Sarama is an MIT-licensed Go client library for Apache Kafka version 0.8 (and later).
...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,942 | 🐛 157 | 🌐 Java | 📅 2026-09-25 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
...
* [cruise-control](https://github.com/linkedin/cruise-control) ⭐ 3,046 | 🐛 278 | 🌐 Java | 📅 2026-09-25 - Cruise-control is the first of its kind to fully automate the dynamic workload rebalance and self-healing of a kafka cluster.
* [spring-kafka](https://github.com/spring-projects/spring-kafka) ⭐ 2,509 | 🐛 36 | 🌐 Java | 📅 2026-09-26
...
* [kowl](https://github.com/cloudhut/kowl) ⭐ 4,335 | 🐛 147 | 🌐 TypeScript | 📅 2026-09-25
...
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 165 | 🐛 276 | 🌐 Java | 📅 2026-09-26 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,464 | 🐛 395 | 🌐 Java | 📅 2026-09-26 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 939 | 🐛 742 | 🌐 Java | 📅 2026-09-25 - Apicurio API/schema registry (includes UI).
...
* [dharmeshkakadia/awesome-kafka](https://github.com/dharmeshkakadia/awesome-kafka) ⭐ 209 | 🐛 3 | 📅 2026-08-06
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,338 | 🐛 1,762 | 🌐 Java | 📅 2026-09-26
