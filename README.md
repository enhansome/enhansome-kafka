...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,519 | 🐛 44 | 🌐 Go | 📅 2026-09-09 - Sarama is an MIT-licensed Go client library for Apache Kafka version 0.8 (and later).
...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,928 | 🐛 159 | 🌐 Java | 📅 2026-09-10 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
...
* [kafkahq](https://github.com/tchiotludo/kafkahq) ⭐ 3,851 | 🐛 299 | 🌐 Java | 📅 2026-09-10 - Kafka GUI for topics, topics data, consumers group, schema registry, connect and more.
...
* [cruise-control](https://github.com/linkedin/cruise-control) ⭐ 3,045 | 🐛 283 | 🌐 Java | 📅 2026-09-10 - Cruise-control is the first of its kind to fully automate the dynamic workload rebalance and self-healing of a kafka cluster.
* [spring-kafka](https://github.com/spring-projects/spring-kafka) ⭐ 2,504 | 🐛 45 | 🌐 Java | 📅 2026-09-10
...
* [kowl](https://github.com/cloudhut/kowl) ⭐ 4,333 | 🐛 153 | 🌐 TypeScript | 📅 2026-09-10
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,727 | 🐛 246 | 🌐 Java | 📅 2026-09-10 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [strimzi-http-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ⭐ 340 | 🐛 14 | 🌐 Java | 📅 2026-09-09 - Strimzi Kafka Bridge (AMQP & HTTP).
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 162 | 🐛 277 | 🌐 Java | 📅 2026-09-10 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,464 | 🐛 393 | 🌐 Java | 📅 2026-09-10 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 932 | 🐛 673 | 🌐 Java | 📅 2026-09-10 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,328 | 🐛 1,760 | 🌐 Java | 📅 2026-09-10
* [faust](https://github.com/robinhood/faust) ⭐ 6,825 | 🐛 280 | 🌐 Python | 📅 2024-07-27 - Python Stream Processing.
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,807 | 🐛 50 | 🌐 Java | 📅 2026-09-10
* [Heron](https://github.com/apache/incubator-heron) ⚠️ Archived
* [CorfuDB](https://github.com/CorfuDB/CorfuDB) ⭐ 667 | 🐛 202 | 🌐 Java | 📅 2026-09-09
