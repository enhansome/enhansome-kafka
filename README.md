...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,522 | 🐛 45 | 🌐 Go | 📅 2026-09-15 - Sarama is an MIT-licensed Go client library for Apache Kafka version 0.8 (and later).
...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,934 | 🐛 156 | 🌐 Java | 📅 2026-09-16 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
...
* [kafkahq](https://github.com/tchiotludo/kafkahq) ⭐ 3,853 | 🐛 274 | 🌐 Java | 📅 2026-09-16 - Kafka GUI for topics, topics data, consumers group, schema registry, connect and more.
...
* [cruise-control](https://github.com/linkedin/cruise-control) ⭐ 3,045 | 🐛 278 | 🌐 Java | 📅 2026-09-14 - Cruise-control is the first of its kind to fully automate the dynamic workload rebalance and self-healing of a kafka cluster.
* [spring-kafka](https://github.com/spring-projects/spring-kafka) ⭐ 2,507 | 🐛 39 | 🌐 Java | 📅 2026-09-15
...
* [kowl](https://github.com/cloudhut/kowl) ⭐ 4,333 | 🐛 149 | 🌐 TypeScript | 📅 2026-09-16
...
* [snowflake-kafka-connector](https://github.com/snowflakedb/snowflake-kafka-connector) ⭐ 177 | 🐛 51 | 🌐 Java | 📅 2026-09-10
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,726 | 🐛 256 | 🌐 Java | 📅 2026-09-16 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [strimzi-http-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ⭐ 341 | 🐛 14 | 🌐 Java | 📅 2026-09-11 - Strimzi Kafka Bridge (AMQP & HTTP).
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 162 | 🐛 277 | 🌐 Java | 📅 2026-09-16 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,466 | 🐛 393 | 🌐 Java | 📅 2026-09-16 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 935 | 🐛 708 | 🌐 Java | 📅 2026-09-16 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,331 | 🐛 1,731 | 🌐 Java | 📅 2026-09-16
* [faust](https://github.com/robinhood/faust) ⭐ 6,824 | 🐛 280 | 🌐 Python | 📅 2024-07-27 - Python Stream Processing.
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,813 | 🐛 47 | 🌐 Java | 📅 2026-09-16
