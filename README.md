...
* [spring-kafka](https://github.com/spring-projects/spring-kafka) ⭐ 2,495 | 🐛 36 | 🌐 Java | 📅 2026-08-13
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,054 | 🐛 225 | 🌐 Java | 📅 2026-08-14 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [strimzi-http-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ⭐ 338 | 🐛 15 | 🌐 Java | 📅 2026-08-14 - Strimzi Kafka Bridge (AMQP & HTTP).
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 162 | 🐛 275 | 🌐 Java | 📅 2026-08-14 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,460 | 🐛 397 | 🌐 Java | 📅 2026-08-14 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 907 | 🐛 602 | 🌐 Java | 📅 2026-08-14 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,310 | 🐛 1,704 | 🌐 Java | 📅 2026-08-14
