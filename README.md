...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,518 | 🐛 44 | 🌐 Go | 📅 2026-09-09 - Sarama is an MIT-licensed Go client library for Apache Kafka version 0.8 (and later).
...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,928 | 🐛 157 | 🌐 Java | 📅 2026-09-09 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
* [kafkacat](https://github.com/edenhill/kafkacat) ⭐ 5,781 | 🐛 162 | 🌐 C | 📅 2024-07-09 - Generic command line non-JVM Apache Kafka producer and consumer.
...
* [kafkahq](https://github.com/tchiotludo/kafkahq) ⭐ 3,851 | 🐛 298 | 🌐 Java | 📅 2026-09-07 - Kafka GUI for topics, topics data, consumers group, schema registry, connect and more.
...
* [cruise-control](https://github.com/linkedin/cruise-control) ⭐ 3,045 | 🐛 287 | 🌐 Java | 📅 2026-09-03 - Cruise-control is the first of its kind to fully automate the dynamic workload rebalance and self-healing of a kafka cluster.
* [spring-kafka](https://github.com/spring-projects/spring-kafka) ⭐ 2,504 | 🐛 43 | 🌐 Java | 📅 2026-09-08
...
* [Kafdrop](https://github.com/obsidiandynamics/kafdrop) ⭐ 6,153 | 🐛 43 | 🌐 Java | 📅 2026-09-07 - Web UI for browsing Kafka topics and consumer groups.
* [kowl](https://github.com/cloudhut/kowl) ⭐ 4,333 | 🐛 155 | 🌐 TypeScript | 📅 2026-09-09
...
* [snowflake-kafka-connector](https://github.com/snowflakedb/snowflake-kafka-connector) ⭐ 177 | 🐛 51 | 🌐 Java | 📅 2026-09-08
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,731 | 🐛 244 | 🌐 Java | 📅 2026-09-08 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [strimzi-http-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ⭐ 340 | 🐛 14 | 🌐 Java | 📅 2026-09-09 - Strimzi Kafka Bridge (AMQP & HTTP).
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 162 | 🐛 277 | 🌐 Java | 📅 2026-09-09 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,464 | 🐛 400 | 🌐 Java | 📅 2026-09-09 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 931 | 🐛 671 | 🌐 Java | 📅 2026-09-09 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,326 | 🐛 1,755 | 🌐 Java | 📅 2026-09-09
* [faust](https://github.com/robinhood/faust) ⭐ 6,825 | 🐛 280 | 🌐 Python | 📅 2024-07-27 - Python Stream Processing.
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,807 | 🐛 50 | 🌐 Java | 📅 2026-09-09
* [Heron](https://github.com/apache/incubator-heron) ⚠️ Archived
* [CorfuDB](https://github.com/CorfuDB/CorfuDB) ⭐ 667 | 🐛 201 | 🌐 Java | 📅 2026-09-03
