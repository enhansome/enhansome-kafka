...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,516 | 🐛 45 | 🌐 Go | 📅 2026-09-08 - Sarama is an MIT-licensed Go client library for Apache Kafka version 0.8 (and later).
...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,928 | 🐛 164 | 🌐 Java | 📅 2026-09-08 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
...
* [cruise-control](https://github.com/linkedin/cruise-control) ⭐ 3,045 | 🐛 286 | 🌐 Java | 📅 2026-09-03 - Cruise-control is the first of its kind to fully automate the dynamic workload rebalance and self-healing of a kafka cluster.
* [spring-kafka](https://github.com/spring-projects/spring-kafka) ⭐ 2,503 | 🐛 43 | 🌐 Java | 📅 2026-09-07
...
* [Kafdrop](https://github.com/obsidiandynamics/kafdrop) ⭐ 6,152 | 🐛 43 | 🌐 Java | 📅 2026-09-07 - Web UI for browsing Kafka topics and consumer groups.
* [kowl](https://github.com/cloudhut/kowl) ⭐ 4,331 | 🐛 159 | 🌐 TypeScript | 📅 2026-09-08
...
* [snowflake-kafka-connector](https://github.com/snowflakedb/snowflake-kafka-connector) ⭐ 177 | 🐛 49 | 🌐 Java | 📅 2026-09-08
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,730 | 🐛 243 | 🌐 Java | 📅 2026-09-07 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [strimzi-http-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ⭐ 340 | 🐛 15 | 🌐 Java | 📅 2026-09-08 - Strimzi Kafka Bridge (AMQP & HTTP).
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 162 | 🐛 277 | 🌐 Java | 📅 2026-09-08 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,464 | 🐛 393 | 🌐 Java | 📅 2026-09-08 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 931 | 🐛 652 | 🌐 Java | 📅 2026-09-08 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,326 | 🐛 1,758 | 🌐 Java | 📅 2026-09-08
* [faust](https://github.com/robinhood/faust) ⭐ 6,825 | 🐛 280 | 🌐 Python | 📅 2024-07-27 - Python Stream Processing.
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,805 | 🐛 51 | 🌐 Java | 📅 2026-09-08
