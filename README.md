...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,916 | 🐛 154 | 🌐 Java | 📅 2026-08-27 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
...
* [spring-kafka](https://github.com/spring-projects/spring-kafka) ⭐ 2,497 | 🐛 38 | 🌐 Java | 📅 2026-08-26
...
* [Kafdrop](https://github.com/obsidiandynamics/kafdrop) ⭐ 6,153 | 🐛 45 | 🌐 Java | 📅 2026-08-26 - Web UI for browsing Kafka topics and consumer groups.
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,711 | 🐛 224 | 🌐 Java | 📅 2026-08-27 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [strimzi-http-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ⭐ 338 | 🐛 14 | 🌐 Java | 📅 2026-08-25 - Strimzi Kafka Bridge (AMQP & HTTP).
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 162 | 🐛 277 | 🌐 Java | 📅 2026-08-27 - Confluent REST Proxy.
...
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 921 | 🐛 632 | 🌐 Java | 📅 2026-08-27 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,315 | 🐛 1,739 | 🌐 Java | 📅 2026-08-27
* [faust](https://github.com/robinhood/faust) ⭐ 6,825 | 🐛 279 | 🌐 Python | 📅 2024-07-27 - Python Stream Processing.
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,798 | 🐛 44 | 🌐 Java | 📅 2026-08-27
