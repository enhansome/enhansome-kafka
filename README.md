...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,921 | 🐛 155 | 🌐 Java | 📅 2026-08-27 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
...
* [spring-kafka](https://github.com/spring-projects/spring-kafka) ⭐ 2,498 | 🐛 43 | 🌐 Java | 📅 2026-08-28
...
* [Kafdrop](https://github.com/obsidiandynamics/kafdrop) ⭐ 6,154 | 🐛 46 | 🌐 Java | 📅 2026-08-27 - Web UI for browsing Kafka topics and consumer groups.
* [kowl](https://github.com/cloudhut/kowl) ⭐ 4,325 | 🐛 156 | 🌐 TypeScript | 📅 2026-08-28
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,713 | 🐛 227 | 🌐 Java | 📅 2026-08-28 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [strimzi-http-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ⭐ 339 | 🐛 14 | 🌐 Java | 📅 2026-08-27 - Strimzi Kafka Bridge (AMQP & HTTP).
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 162 | 🐛 275 | 🌐 Java | 📅 2026-08-29 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,463 | 🐛 390 | 🌐 Java | 📅 2026-08-29 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 922 | 🐛 621 | 🌐 Java | 📅 2026-08-28 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,316 | 🐛 1,731 | 🌐 Java | 📅 2026-08-28
* [faust](https://github.com/robinhood/faust) ⭐ 6,825 | 🐛 279 | 🌐 Python | 📅 2024-07-27 - Python Stream Processing.
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,799 | 🐛 47 | 🌐 Java | 📅 2026-08-28
