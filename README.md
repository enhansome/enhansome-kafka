...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,505 | 🐛 30 | 🌐 Go | 📅 2026-08-12 - Sarama is an MIT-licensed Go client library for Apache Kafka version 0.8 (and later).
...
* [Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,904 | 🐛 151 | 🌐 Java | 📅 2026-08-15 - Operator for deploying and running Apache Kafka on Kubernetes and OpenShift.
* [kafkacat](https://github.com/edenhill/kafkacat) ⭐ 5,776 | 🐛 162 | 🌐 C | 📅 2024-07-09 - Generic command line non-JVM Apache Kafka producer and consumer.
...
* [cruise-control](https://github.com/linkedin/cruise-control) ⭐ 3,039 | 🐛 288 | 🌐 Java | 📅 2026-08-15 - Cruise-control is the first of its kind to fully automate the dynamic workload rebalance and self-healing of a kafka cluster.
* [spring-kafka](https://github.com/spring-projects/spring-kafka) ⭐ 2,495 | 🐛 37 | 🌐 Java | 📅 2026-08-13
...
* [hermes](https://github.com/allegro/hermes) ⭐ 865 | 🐛 8 | 🌐 Java | 📅 2026-08-13 - Fast and reliable message broker built on top of Kafka.
...
* [Kafdrop](https://github.com/obsidiandynamics/kafdrop) ⭐ 6,155 | 🐛 51 | 🌐 Java | 📅 2026-08-11 - Web UI for browsing Kafka topics and consumer groups.
* [kowl](https://github.com/cloudhut/kowl) ⭐ 4,317 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-14
...
* [Maxwell](https://github.com/zendesk/maxwell) ⭐ 4,254 | 🐛 266 | 🌐 Java | 📅 2026-08-13
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,057 | 🐛 225 | 🌐 Java | 📅 2026-08-15 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [strimzi-http-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ⭐ 338 | 🐛 16 | 🌐 Java | 📅 2026-08-14 - Strimzi Kafka Bridge (AMQP & HTTP).
* [kafka-rest](https://github.com/confluentinc/kafka-rest) ⭐ 162 | 🐛 275 | 🌐 Java | 📅 2026-08-15 - Confluent REST Proxy.

### KSQL

### Schema Registry

* [schema-registry](https://github.com/confluentinc/schema-registry) ⭐ 2,460 | 🐛 393 | 🌐 Java | 📅 2026-08-15 - Confluent Schema registry for Kafka.
* [apicurio-registry](https://github.com/Apicurio/apicurio-registry) ⭐ 909 | 🐛 624 | 🌐 Java | 📅 2026-08-15 - Apicurio API/schema registry (includes UI).
...
* [Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,311 | 🐛 1,706 | 🌐 Java | 📅 2026-08-15
* [faust](https://github.com/robinhood/faust) ⭐ 6,823 | 🐛 278 | 🌐 Python | 📅 2024-07-27 - Python Stream Processing.
...
* [CorfuDB](https://github.com/CorfuDB/CorfuDB) ⭐ 665 | 🐛 201 | 🌐 Java | 📅 2026-08-13
